...
import (
	...
	tutorialsv1 "github.com/taha-ahmadi/kuber-operator/api/v1"
)

// KONginxReconciler reconciles a OvhNginx object
type KONginxReconciler struct {
	client.Client
...
func (r *KONginxReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := ctrllog.FromContext(ctx)
	ovhNginx := &tutorialsv1.KONginx{}
	...
	if err != nil {
		if errors.IsNotFound(err) {
			log.Info("KONginx resource not found, check if a deployment must be deleted.")
...
func (r *KONginxReconciler) createDeployment(ovhNginxCR *tutorialsv1.KONginx) *appsv1.Deployment {
...
func (r *KONginxReconciler) createService(ovhNginxCR *tutorialsv1.KONginx) *corev1.Service {
...
func (r *KONginxReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&tutorialsv1.KONginx{}).
